    ...
    <div id="login-screen">
      <div className="login-card">
        ...
        {loading ? (
          ...
          <>
            <p style={{ fontSize: '12px', color: 'var(--ink4)', marginBottom: '20px' }}>
              Acesse usando sua conta Google institucional ou cadastrada.
            </p>
            ...
            >
              ...
              <span style={{ fontWeight: 600, fontSize: '16px' }}>Entrar com Google</span>
            </button>
          </>
        )}

        <div style={{ marginTop: '40px', fontSize: '11px', color: 'var(--ink4)' }}>
          Sistema de Apoio ao Regime Especial de Habilitação
        </div>
      </div>
    </div>
  );
