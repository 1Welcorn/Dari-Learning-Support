...
export const DEFAULT_UNITS: Unit[] = [
  ...
  {id:'u6',color:'natural',sort_order:3,title:'Receita',sub:'Aula 4',
   ...
   brief:'Ela é a professora hoje.',plan_c:'Receita; verbos de instrução',plan_h:'Produzir frase instrucional',plan_e:'Inversão de papel',plan_a:'1 frase completa',wa:'Aula 4 — Receita! 🍽️',questions:[{q:'Qual prato você quer me ensinar hoje?',type:'text'}]},
  ...
  {id:'u3',color:'natural',sort_order:5,title:'Apresentação Pessoal',sub:'Aula 6',
   ...
   brief:'"My name is...".',plan_c:'Apresentação pessoal',plan_h:'Produzir frase simples',plan_e:'Mediador modela',plan_a:'Produção oral',wa:'Aula 6 — Apresentação! 🙋‍♀️',questions:[{q:'O que significa MY NAME IS?',type:'mc',opts:['Meu nome é','Eu gosto de','Eu tenho','Onde fica']}]},
  ...
  {id:'u2',color:'natural',sort_order:8,title:'Compreensão Oral',sub:'Aula 9',
   icon3D: '/unit-icons/aula-2.png', iconOutline: '/unit-icons/aula-2-off.png',
   brief:'Repita DUAS vezes.',plan_c:'Compreensão oral',plan_h:'Identificar palavra-chave',plan_e:'Leitura em voz alta',plan_a:'Identificação correta',wa:'Aula 9 — Escuta em inglês 👂',questions:[{q:'Quem cozinha em "My MOTHER cooks"?',type:'mc',opts:['Mãe','Avó','Irmã','Tia']}]},
  
  {id:'u5',color:'natural',sort_order:9,title:'Gêneros Digitais',sub:'Aula 10',
   icon3D: '/unit-icons/aula-5.png', iconOutline: '/unit-icons/aula-5-off.png',
   brief:'Use o celular REAL.',plan_c:'Gêneros digitais',plan_h:'Identificar STORY, LIKE',plan_e:'Celular real',plan_a:'Identificação correta',wa:'Aula 10 — Inglês no celular 📱',questions:[{q:'O que é uma STORY?',type:'mc',opts:['Foto/vídeo que some','Mensagem','Seguir','Comentário']}]},
  
  {id:'u12',color:'natural',sort_order:10,title:'Revisão do módulo',sub:'Aula 11',
   icon3D: '/unit-icons/aula-1.png', iconOutline: '/unit-icons/aula-1-off.png',
   brief:'Celebrar o progresso.',plan_c:'Revisão geral',plan_h:'Recuperar termos',plan_e:'Celebração',plan_a:'Participação ativa',wa:'Aula 11 — Revisão! 🎉',questions:[{q:'Qual sua palavra favorita?',type:'text'}]}
];
